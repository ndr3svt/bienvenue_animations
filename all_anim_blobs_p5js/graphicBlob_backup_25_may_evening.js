class Blob{
    ...
    updateShape(_type,_val){
      if(_type == 'mirrored'){
        ...
        let shift_y = map(_val, 50,-20,0,20);
        this.pg.clear()
        ...
        let shift_y = map(_val, 0,50,0,25);
        this.pg.clear()
        this.pg.noStroke()
        this.pg.beginShape()
        this.pg.vertex(0,this.fy-shift_y)
        this.pg.quadraticVertex(this.lw/2, this.fy-50 +_val*1.5, this.lw, this.fy-shift_y);
        this.pg.vertex(this.lw,this.fy-shift_y)
        this.pg.vertex(this.lw,this.fy*2+this.lh-shift_y)
        this.pg.quadraticVertex(this.lw/2, this.fy*2+this.lh-50 +_val*1.5 , 0, this.fy*2+this.lh-shift_y);
        this.pg.vertex(0,this.fy*2+this.lh-shift_y)
        this.pg.endShape()
      }
    }
    customShape(_type){
